...
public class GroupMembershipRegistrarTest {
    ...
    public void shouldRegisterNewMembership() throws Exception {
        groupMembershipRegistrar.registerAgent(expectedGroupId, new LeaderRequirements(mandatoryLeaderParameters, null), agentParameters);
    ...
    public void shouldCalculateScoreWhileRegistering() throws Exception {
        ...
        groupMembershipRegistrar.registerAgent(expectedGroupId, new LeaderRequirements(mandatoryLeaderParameters, optionalLeaderParameters), agentParameters);
